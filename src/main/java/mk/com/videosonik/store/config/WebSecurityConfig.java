package mk.com.videosonik.store.config;
...
//                .and().authorizeRequests().antMatchers(HttpMethod.PATCH, "/products/**").hasRole("ADMIN")
                ...
                // WISHLIST
                .and().authorizeRequests().antMatchers(HttpMethod.POST, "/wishlist/**").permitAll()

                .and().authorizeRequests().antMatchers("/cart/process/**").permitAll()
                .and().authorizeRequests().antMatchers("/cart/editQuantity/**/**").permitAll()
                .and().authorizeRequests().antMatchers("/cart//history/**").permitAll()
